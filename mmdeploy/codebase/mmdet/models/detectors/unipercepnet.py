...
@FUNCTION_REWRITER.register_rewriter(
    'src.modeling.unipercepnet.UniPercepNet.extract_feat')
def unipercepnet__extract_feat(self, img):
...
@FUNCTION_REWRITER.register_rewriter(
    'src.modeling.unipercepnet.UniPercepNet.forward')
def unipercepnet__forward(self,
    ...
    if data_samples[0].get('proposals', None) is None:
        rpn_results_list = self.bbox_head.predict(

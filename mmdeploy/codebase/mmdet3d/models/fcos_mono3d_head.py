...
@FUNCTION_REWRITER.register_rewriter(
    'mmdet3d.models.dense_heads.fcos_mono3d_head.FCOSMono3DHead.predict_by_feat')
def fcosmono3dhead__predict_by_feat(
    self,
    cls_scores,
    bbox_preds,
    dir_cls_preds,
    ...
    """Rewrite `predict_by_feat` of `FCOSMono3DHead` for default backend.

...
print(f"Result 3d boxes: {result.pred_instances_3d.bboxes_3d.tensor[:3]}")

drawed_image = task_processor.draw_bboxes(image, result)

cv2.imshow('drawed_image', drawed_image[..., ::-1])  # Convert RGB to BGR for OpenCV
cv2.waitKey(0)
